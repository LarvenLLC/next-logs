...
const Logger = {
  console: new console.Console(fs.createWriteStream(logFiles.console, {
    flags: 'a', // 'a' means appending (old data will be preserved)
  })),
  info: new console.Console(fs.createWriteStream(logFiles.info, {
    flags: 'a', // 'a' means appending (old data will be preserved)
  })),
  debug: new console.Console(fs.createWriteStream(logFiles.debug, {
    flags: 'a', // 'a' means appending (old data will be preserved)
  })),
  warn: new console.Console(fs.createWriteStream(logFiles.warn, {
    flags: 'a', // 'a' means appending (old data will be preserved)
  })),
  error: new console.Console(fs.createWriteStream(logFiles.error, {
    flags: 'a', // 'a' means appending (old data will be preserved)
  })),
};
